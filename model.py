	...
	def build_forward(self):
		...
		with tf.variable_scope("output"):
			...
			if config.use_eu_output:
				# eu similarity
				logits = linear(tf.concat([gq,g1_a_t,gchoices,g1_a_t*gchoices,gq*gchoices,(g1_a_t-gchoices)*(g1_a_t - gchoices),(gq-gchoices)*(gq-gchoices)],2),output_size=1,scope="choicelogits")
			else:
